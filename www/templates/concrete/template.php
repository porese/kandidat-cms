...
<link href="<?php echo $prefflp; ?>/templates/concrete/default.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
<!-- start header -->
<div id="header">
	...
	<div id="sidebar">
		<ul>
			...
			<li>
				<h2>Облако меток</h2>
				<ul>
					<li id="nobackground"><p class="entry"><? include("mycode/cloudtags.php"); ?></p></li>
				</ul>
			</li>
			<li>
				<h2>Счетчики</h2>
