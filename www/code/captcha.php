...
$font_file=str_replace("\\","/",dirname(__FILE__))."/Kedage-b-cut.ttf"; /* путь к файлу шрифта, шрифт Kedage распростаняется под лицензией GPL*/
