...
$root_path=preg_replace('/admin\/elrte\/connectors\/php$/u','',$root_path);
require_once($root_path.'code/functions.php');
$opts = array(
	'root'            => $root_path.DIRECTORY_SEPARATOR.'media',                       // path to root directory
	'URL'             => $prefflp.'/media/', // root directory URL
